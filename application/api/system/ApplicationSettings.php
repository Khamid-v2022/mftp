<?php
    ...
    class ApplicationSettings {
        ...
        private static $KEY_DISABLE_CREATE_ZIP_ARCHIVE = "disableCreateZipArchive";
        ...
        private function getValidKeys() {
            ...
            return array(
                ...
                self::$KEY_DISABLE_CREATE_ZIP_ARCHIVE,
        ...
        private function getDefaults() {
            return array(
                ...
                self::$KEY_DISABLE_CREATE_ZIP_ARCHIVE => true,
        ...
        public function getDisableCreateZipArchive() {
            return $this->getSetKey(self::$KEY_DISABLE_CREATE_ZIP_ARCHIVE);
        }

        public function setDisableCreateZipArchive($disableCreateZipArchive) {
            $this->setBool(self::$KEY_DISABLE_CREATE_ZIP_ARCHIVE, $disableCreateZipArchive);
        }
